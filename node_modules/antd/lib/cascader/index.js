...
var Cascader = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Cascader, [{
        ...
        value: function render() {
            ...
            var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(_icon2['default'], { type: 'close', className: prefixCls + '-picker-clear', onClick: this.clearSelection }) : null;
